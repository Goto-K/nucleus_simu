...
CCC   *
      ...
      integer :: N,ndim
      parameter (N=5,ndim=10)
      integer :: INFO,LWORK
      parameter (LWORK=2*Ndim-1)
      real*8, dimension(3*Ndim-2) :: RWORK
      real*8, dimension(Ndim) :: ene,ene2
      real*8, dimension(LWORK) :: WORK
      real*8, dimension(Ndim,Ndim) :: ham,ham2,vec,vec2
...
!—hamをvecにうつす—
      vec(1:N,1:N)=ham(1:N,1:N)
      ham2(1:N,1:N)=ham(1:N,1:N)

      do i=1,n
      write(*,'(F10.5,9(1X,F10.5))') (ham2(j,i),j=1,n)
      end do

!—固有値・固有ベクトルを求める
      call dsyev(JOBZ,UPLO,N,vec,Ndim,ene,rwork,lwork,info)
      ...
      write(*,*) '==========================='
      call hqr(ndim,n,ham2,vec2,ene2)
