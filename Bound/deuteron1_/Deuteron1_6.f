...
CCC
      ...
      CN0(i)=sqrt(4*sqrt(((2d0*b(i))**3)/pi))
...
CCC   norm matrix
      ...
      N(i,j,l1,l2)
     & = CN0(i)*CN0(j)*sqrt(pi)/sqrt(b(i)+b(j))/4d0/(b(i)+b(j))
      n_0(i,j)=N(i,j,1,1)
      n_0(j,i)=n_0(i,j)
      n0_0(i,j)=n_0(i,j)
      n0_0(j,i)=n0_0(i,j)
      ...
      N(i,j,l1,l2)
     & = CN2(i)*CN2(j)*sqrt(pi)/sqrt(b(i)+b(j))*15d0/16d0/(b(i)+b(j))**3
      n_2(i,j)=N(i,j,3,3)
      n_2(j,i)=n_2(i,j)
      n0_2(i,j)=n_2(i,j)
      n0_2(j,i)=n0_2(i,j)
...
CCC   kinetic energy matrix
     ...
     & * sqrt(pi)/sqrt(b(i)+b(j))/4d0/(b(i)+b(j))
     & * 6d0*b(i)*b(j)/(b(i)+b(j))
      else if(l1==3.and.l2==3)then
      T(i,j,l1,l2)
     & = CN2(i)*CN2(j)*hc0**2/(2*rem) 
     & * sqrt(pi)/sqrt(b(i)+b(j))*15d0/16d0/(b(i)+b(j))**3
     & * 14d0*b(i)*b(j)/(b(i)+b(j))
      else
      T(i,j,l1,l2)=0
      end if
...
CCC   VC(i,j,l1,l2)
     ...
     & + CN0(i)*CN0(j)*CVC(k)
     & * (sqrt(pi)/(sqrt(b(i)+b(j)+1/ic(k)**2))**3)/4d0
      else if(l1==3.and.l2==3)then
      VC(i,j,l1,l2)=VC(i,j,l1,l2)
     & + CN2(i)*CN2(j)*CVC(k)
     & * (sqrt(pi)/(sqrt(b(i)+b(j)+1/ic(k)**2))**7)*15d0/16d0
      else if(l1==1.and.l2==3)then
      VC(i,j,l1,l2)=VC(i,j,l1,l2)
     & + CN0(i)*CN2(j)*CVC(k)
     & * (sqrt(pi)/(sqrt(b(i)+b(j)+1/ic(k)**2))**5)*3d0/8d0
...
CCC   VT(i,j,l1,l2)
     ...
     & + CN0(i)*CN0(j)*CVT(k)
     & * (sqrt(pi)/(sqrt(b(i)+b(j)+1/it(k)**2))**3)/4d0
      else if(l1==3.and.l2==3)then
      VT(i,j,l1,l2)=VT(i,j,l1,l2)
     & + CN2(i)*CN2(j)*CVT(k)
     & * (sqrt(pi)/(sqrt(b(i)+b(j)+1/it(k)**2))**7)*15d0/16d0
      else if(l1==1.and.l2==3)then
      VT(i,j,l1,l2)=VT(i,j,l1,l2)
     & + CN0(i)*CN2(j)*CVT(k)
     & * (sqrt(pi)/(sqrt(b(i)+b(j)+1/it(k)**2))**5)*3d0/8d0
      else if(l1==3.and.l2==1)then
      VT(i,j,l1,l2)=VT(i,j,l1,l2)
     & + CN2(i)*CN0(j)*CVT(k)
     & * (sqrt(pi)/(sqrt(b(i)+b(j)+1/it(k)**2))**5)*3d0/8d0
