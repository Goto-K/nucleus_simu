...
CCC   *
     ...
     &           nmax=15,mmax=10,omax=15,pmax=10)
...
C    <1|T(r1)|1>+<1|T(r1)|2>+<1|T(r1)|3>
     ...
     & = hc**2 / (2d0*rem1)
C     & = cn1(i,k)*cn1(j,l)*hc**2 / (2d0*rem1)
...
C    <1|T(R1)|1>+<1|T(R1)|2>+<1|T(R1)|3>
     ...
     & + hc**2 / (2d0*rem2)
C     & + cn1(i,k)*cn1(j,l)*hc**2 / (2d0*rem2)
...
CCC   <1|V1|1> + 2*<1|V1|2> + 2*<1|V2|1> + 4*<1|V2|3>
     ...
     & = rem1 / (2*hc**2)
C     & = cn1(i,k)*cn1(j,l)*rem1 / (2*hc**2)
     & * 3d0/8d0 * sqrt((pi)/(bx(i)+bx(j))**5)
     & * 1d0/2d0**2 * sqrt((pi)/((By(k)+By(l))**3))

     & + 2d0
     & * rem1 / (2*hc**2)
C     & * cn1(i,k)*cn2(j,l)*rem1 / (2*hc**2)
