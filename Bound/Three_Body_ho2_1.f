...
C     & = hc0**2 / (2d0*rem1)
     & = cn1(i,k)*cn1(j,l)*hc0**2 / (2d0*rem1)
     & * 3d0/2d0*bx(i)*bx(j) * sqrt((pi)/(bx(i)+bx(j))**5)
     & * 1d0/2d0**2 * sqrt((pi)/((By(k)+By(l))**3))
     & + 2d0 
C     & * hc0**2 / (2d0*rem1)
     & * cn2(i,k)*cn2(j,l)*hc0**2 / (2d0*rem1)
...
C     & + hc0**2 / (2d0*rem2)
     & + cn1(i,k)*cn1(j,l)*hc0**2 / (2d0*rem2)
     & * 3d0/2d0*By(k)*By(l) * sqrt((pi)/(By(k)+By(l))**5)
     & * 1d0/2d0**2 * sqrt((pi)/((bx(i)+bx(j))**3)) 
     & + 2d0
C     & * hc0**2 / (2d0*rem2)
     & * cn2(i,k)*cn2(j,l)*hc0**2 / (2d0*rem2)
...
C     & = 1d0/2d0**2 * sqrt((pi)/((bx(i)+bx(j))**3)) 
